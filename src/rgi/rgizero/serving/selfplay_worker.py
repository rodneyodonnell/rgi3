...
def run_selfplay_worker(
    ...
    async def run_games():
            ...
            async def _batch_loop(self):
                ...
                while True:
                    ...
                    encoded_actions_list = [
                        np.array(vocab.encode(actions), dtype=np.int64) for actions in legal_actions_list
                    ]
        ...
        async def play_one():
            ...
            player = AlphazeroPlayer(game, evaluator, rng=player_rng, add_noise=True, simulations=num_simulations)
